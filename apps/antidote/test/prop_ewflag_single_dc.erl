...
-define(CRDT, antidote_crdt_flag_ew).

%%%%%%%%%%%%%%%%%%
%%% PROPERTIES %%%
%%%%%%%%%%%%%%%%%%
prop_ewflag_single_dc_test() ->
...
initial_state() ->
    Bucket = test_bucket_ewflag_single_dc, 
    Key = antidote_prop_ewflag_single_dc,

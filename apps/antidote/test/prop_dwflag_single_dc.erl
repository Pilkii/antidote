...
-define(CRDT, antidote_crdt_flag_dw).

%%%%%%%%%%%%%%%%%%
%%% PROPERTIES %%%
%%%%%%%%%%%%%%%%%%
prop_dwflag_single_dc_test() ->
...
initial_state() ->
    Bucket = test_bucket_dwflag_single_dc, 
    Key = antidote_prop_dwflag_single_dc,

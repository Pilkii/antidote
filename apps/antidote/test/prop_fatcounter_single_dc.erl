-module(prop_fatcounter_single_dc).
...
-define(CRDT, antidote_crdt_counter_fat).

%%%%%%%%%%%%%%%%%%
%%% PROPERTIES %%%
%%%%%%%%%%%%%%%%%%
prop_fatcounter_single_dc_test() ->
...
initial_state() ->
    Bucket = test_bucket_fatcounter_single_dc, 
    Key = antidote_prop_fatcounter_single_dc,

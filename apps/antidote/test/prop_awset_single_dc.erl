...
-define(CRDT, antidote_crdt_set_aw).

%%%%%%%%%%%%%%%%%%
%%% PROPERTIES %%%
%%%%%%%%%%%%%%%%%%
prop_awset_single_dc_test() ->
...
initial_state() ->
    Bucket = test_bucket_awset_single_dc, 
    Key = antidote_prop_awset_single_dc,
...
op(State) ->
  oneof([
    {State#state.object, add, element_from_set(State#state.set)},
